...
import la.xiaosiwo.laught.common.CommonIntentExtra;
import la.xiaosiwo.laught.common.Constant;
import la.xiaosiwo.laught.models.POThemeSingle;
import la.xiaosiwo.laught.views.ThemeGroupLayout;
import la.xiaosiwo.laught.views.ThemeView;
...
public class MediaPreviewActivity extends BaseActivity implements OnClickListener {
	...
	public void showThemeStore() {
		...
		videoProcessEngine.loadEffectStore(VideoEffectFuncModel.THEME_TYPE_MV, new OnStoreDataLoadListener<VideoEffectStoreModel>() {
	...
	private void showLocalMusicList() {
		...
		videoProcessEngine.loadLocalMusic("", new OnLocalMusicLoadListener() {
...
//		}
		...
		public void onClick(final View v) {
			...
			videoProcessEngine.downloadEffectAsset(VideoEffectFuncModel.THEME_TYPE_RECOMMEND_MV, theme.effectID, new OnAssetDownloadListener() {
				...
				public void onProgressChanged(int progress) {
					...
					theme.downloadStatus = DownloadStatus.DOWNLOADING;
					runOnUiThread(new Runnable() {
						public void run() {
	 ...
	 * 应用音乐主题回调
	 */
	private OnMusicApplyListener mOnMusicApplyListener = new OnMusicApplyListener() {
	...
	private OnClickListener mThemeDownloadClickListener = new OnClickListener() {
		...
		public void onClick(final View v) {
			...
			if (videoFuncList != null && videoFuncList.effectFuncModels != null && videoFuncList.effectFuncModels.size() > 0) {
				for (VideoEffectFuncModel videoEffectFuncModel : videoFuncList.effectFuncModels) {
